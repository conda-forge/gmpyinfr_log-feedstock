About gmpyinfr_log-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gmpyinfr_log-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12358&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gmpyinfr_log-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gmpyinfr_log` can be installed with `conda`:
...
```
mamba install gmpyinfr_log
```

It is possible to list all of the versions of `gmpyinfr_log` available on your platform with `conda`:
...
```
mamba search gmpyinfr_log --channel conda-forge
```
...
mamba repoquery search gmpyinfr_log --channel conda-forge

# List packages depending on `gmpyinfr_log`:
mamba repoquery whoneeds gmpyinfr_log --channel conda-forge

# List dependencies of `gmpyinfr_log`:
mamba repoquery depends gmpyinfr_log --channel conda-forge
```
